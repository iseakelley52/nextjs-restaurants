...
//Next will use a process to build this page
            ...
            <Row>
                ...
                <Col width="3">
                    ...
                    <Paragraph marginBottom="2">
                       {monday.startTime ?
                        <Fragment>
                            Monday: {monday.startTime} - {monday.closeTime} <br />
                        </Fragment>
                       : <Fragment>Monday: Closed<br /></Fragment>}
                       {tuesday.startTime ? 
                        <Fragment>
                            Tuesday: {tuesday.startTime} - {tuesday.closeTime} <br />
                        </Fragment>
                       : <Fragment>Tuesday: Closed<br /></Fragment>}
                       {wednesday.startTime ?
                        <Fragment>
                            Wednesday: {wednesday.startTime} - {wednesday.closeTime} <br />
                        </Fragment>
                       : <Fragment>Wednesday: Closed<br /></Fragment>}
                       {thursday.startTime ?
                        <Fragment>
                            Thursday: {thursday.startTime} - {thursday.closeTime} <br />
                        </Fragment>
                       : <Fragment>Thursday: Closed<br /></Fragment>}
                       {friday.startTime ? 
                        <Fragment>
                            Friday: {friday.startTime} - {friday.closeTime} <br />
                        </Fragment>
                       : <Fragment>Friday: Closed<br /></Fragment>}
                       {saturday.startTime ? 
                        <Fragment>
                            Saturday: {saturday.startTime} - {saturday.closeTime} <br />
                        </Fragment>
                      : <Fragment>Saturday: Closed<br /></Fragment> }
                       {sunday.startTime ? 
                        <Fragment>
                            Sunday: {sunday.startTime} - {sunday.closeTime} <br />
                        </Fragment>
